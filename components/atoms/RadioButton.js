  ...
  return (
    <div className="flex gap-6 420:gap-8 justify-center items-center">
      <div className="relative">
        <input
          className="outline-none peer appearance-none block w-20 h-20 420:w-24 420:h-24 rounded-20 bg-white ring-[2.5px] 420:ring-[3px] ring-inset ring-gray-400 focus-visible:ring-primary-600 checked:ring-primary-500"
          type="radio"
          name={name}
          id={id}
          value={value}
