...
function getStyledButton(type, handleClick) {
  ...
  return (
    <button onClick={() => handleClick(type)} className="appearance-none outline-none group">
      ...
      <path className="fill-white" fillRule="evenodd" clipRule="evenodd" d="M13.6252 10.375V5.5L10.3752 5.5L10.3752 10.375H5.50024V13.625H10.3752L10.3752 18.5H13.6252V13.625H18.5002V10.375H13.6252Z"/>
      </svg>
    </button>
  );
}
